              ...
              <div>
                ...
                <ul className="mt-2 space-y-2">
                  ...
                  <li className="flex items-center justify-between text-sm">
                    ...
                    <span className="text-gray-400">{orderDetails.totalCompletedOrders}</span>
                  </li>
                  <li className="flex items-center justify-between text-sm">
                    <span>Pending Orders :</span>
                    <span className="text-gray-400">{orderDetails.totalPendingOrders}</span>
                  </li>
                  <li className="flex items-center justify-between text-sm">
                    <span>Accpted Orders :</span>
                    <span className="text-gray-400">{orderDetails.totalAcceptedOrders}</span>
                  </li>
                  <li className="flex items-center justify-between text-sm">
                    <span>Prepared Orders :</span>
                    <span className="text-gray-400">{orderDetails.totalPrepared}</span>
                  </li>
                  <li className="flex items-center justify-between text-sm">
                    <span>OutforPickup Orders :</span>
                    <span className="text-gray-400">{orderDetails.totalOutforPickupOrders}</span>
                  </li>
                  <li className="flex items-center justify-between text-sm">
                    <span className="text-red-400">Rejected Orders :</span>
                    <span className="text-red-400">{orderDetails.totalRejectedOrders}</span>
                  </li>
                </ul>
              </div>
            </nav>
              ...
              >
                ...
                >
                  ...
                  <div className="flex flex-col items-center gap-4 mb-4">
                    ...
                    {selectedOrderId && status !== "Out for Pickup" && status !== "Rejected" && (
                      <button
